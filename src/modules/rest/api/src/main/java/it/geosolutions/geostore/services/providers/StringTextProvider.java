...
/**
 * This is a porting of org.apache.cxf.jaxrs.provider.StringTextProvider, created in a recent
 * version of cxf. It's used in geostore to read the raw request body in in rest service's
 * StoredDataService to retrieve the correct encoding.
 *
...
public class StringTextProvider extends AbstractConfigurableProvider
    ...
    public String readFrom(
        ...
        return IOUtils.toString(
                is, HttpUtils.getSetEncoding(mt, null, StandardCharsets.UTF_8.name()));
    }

    public long getSize(
            String t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mt) {
        return -1;
    }
