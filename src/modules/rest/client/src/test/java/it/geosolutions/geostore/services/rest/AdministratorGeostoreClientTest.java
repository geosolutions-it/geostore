...
public class AdministratorGeostoreClientTest {
    ...
    private static final Logger LOGGER =
            LogManager.getLogger(AdministratorGeostoreClientTest.class);
    ...
    public void testStoredDataServices() {
        ...
        // try to get the related Stored Data with the user "u1", must not be possible due to
        // authorization rules
    ...
    public void testEVERYONEassignmentResources() {
        ...
        RESTUserGroup everyoneGroup =
                geoStoreClient.getUserGroup(GroupReservedNames.EVERYONE.toString());
    ...
    public void updateSecurityRulesTest() {
        ...
        // "u1" and "u2" should not be allowed to READ or WRITE, because they are not the owner of
        // the reosource, it belong to at least one group and the resource doesn't have any groups
        // rule security
        try {
