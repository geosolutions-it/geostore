...
public class OpenIdConnectLoginService extends Oauth2LoginService {
    ...
    private final static Logger LOGGER = LogManager.getLogger(OpenIdConnectLoginService.class.getName());
    ...
    public Response doInternalRedirect(HttpServletRequest request, HttpServletResponse response, String provider) {
        ...
        if (token == null && SecurityContextHolder.getContext() != null) {
            ...
            if (auth != null && auth.getDetails() != null && auth.getDetails() instanceof TokenDetails) {
                ...
                if (accessTokenDetails != null) {
                    ...
                    RequestContextHolder.getRequestAttributes().setAttribute(
                            ACCESS_TOKEN_PARAM, accessTokenDetails, 0);
                    RequestContextHolder.getRequestAttributes().setAttribute(
                ...
                if (tokenDetails.getIdToken() != null) {
                    ...
                    RequestContextHolder.getRequestAttributes().setAttribute(
                            OAuth2AuthenticationDetails.ACCESS_TOKEN_VALUE, tokenDetails.getIdToken(), 0);
                }
            }
        }
