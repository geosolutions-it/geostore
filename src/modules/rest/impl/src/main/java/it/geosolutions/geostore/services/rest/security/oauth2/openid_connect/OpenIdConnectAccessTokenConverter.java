...
/**
 * OpenID Connect AccessTokenConverter. Retrieves Authentication information from the AccessToken.
 */
public class OpenIdConnectAccessTokenConverter extends GeoStoreAccessTokenConverter {
    public OpenIdConnectAccessTokenConverter(String principalKey) {
        super(principalKey);
    }
}
