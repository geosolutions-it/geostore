/*
 * $ Header: it.geosolutions.georepo.services..rest.impl.RESTExtJsServiceImpl ,v. 0.1 9-set-2011 10.39.58 created by tobaro <tobia.dipisa at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class RESTExtJsServiceImpl implements RESTExtJsService{
	...
	/* (non-Javadoc)
	 * @see it.geosolutions.geostore.services.rest.RESTExtJsService#getAllResources(javax.ws.rs.core.UriInfo, javax.ws.rs.core.SecurityContext, java.lang.String, java.lang.Integer, java.lang.Integer)
	 */
	@Override
		...
		if(resources != null){
			...
			while(iterator.hasNext()){
				...
				if(sr != null){
					...
					jobj.element("creation", sr.getCreation());
					jobj.element("description", sr.getDescription());
