...
GeoStore maintainers take security vulnerabilities seriously. Please do not report suspected security vulnerabilities through public GitHub issues, public pull requests, public discussions, mailing lists, or other public channels.

## Supported versions

GeoStore security fixes are normally prepared for the currently maintained release lines.
...
Users running older GeoStore versions are encouraged to upgrade to a supported release. If your organization requires security fixes for an older version, please contact GeoSolutions or your GeoStore support provider to discuss feasibility.
...
[https://github.com/geosolutions-it/geostore/security/advisories/new](https://github.com/geosolutions-it/geostore/security/advisories/new)
...
- affected GeoStore version, release line, commit, or deployment profile;
- affected component, REST endpoint, authentication or authorization flow, resource, category, or configuration;
...
GeoStore follows a coordinated vulnerability disclosure process.
...
This policy covers vulnerabilities in GeoStore source code, authentication and authorization behavior, REST APIs, resource and category access controls, default configurations, official build artifacts, and official documentation where the documentation causes an insecure deployment pattern.

Issues in third-party dependencies may be reported if they materially affect GeoStore users, but they may also need to be coordinated with the upstream dependency maintainers.
